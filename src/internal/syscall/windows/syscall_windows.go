...
//sys	SetFileInformationByHandle_ignored(handle syscall.Handle, fileInformationClass uint32, buf uintptr, bufsize uint32) (err error) = kernel32.SetFileInformationByHandle
...
// Backport: Make SetFileInformationByHandle compatible for
...
// Backport: Reimplement SetFileInformationByHandle with NtSetInformationFile
